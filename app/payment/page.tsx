...
export default function Iuran() {
  ...
  const [showForm, setShowForm] = useState(false); // untuk menampilkan form upload
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    formData.append("iuran_id", iuranId || ""); // kirim iuran_id ke backend
          ...
          <div className="bg-white p-4 mt-1 rounded-b-2xl shadow-md mx-auto w-full max-w-md flex flex-col items-start gap-2">
            ...
            <ul className="list-inside text-sm text-gray-700 space-y-1">
              ...
              <li className="flex items-center gap-2">
                Nomor Rekening:
                <span className="font-mono">1234 567 890</span>
                <button
                  type="button"
